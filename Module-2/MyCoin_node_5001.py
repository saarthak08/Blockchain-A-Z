...
class Blockchain:
    ...
    def add_transaction(self, sender,reciever, amount):
        ...
        previous_block=self.return_previous_block()
...
def mine_block():
    ...
    blockchain.add_transaction(sender=node_address,reciever='Saarthak',amount =1)
...
def replace_chain():
    ...
    if is_chain_replaced:
        response={'message': 'The chain had different nodes so the chain was replaced by the longest chain.',
